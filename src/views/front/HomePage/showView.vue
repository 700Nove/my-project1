  ...
  <div class="home-wrapper">
    ...
    <div class="date-row">
      ...
      <el-card shadow="hover" :body-style="{ padding: '0px' }" class="data-col">
        <div class="date-block">
          <i
            class="el-icon-s-goods icon-box"
            style="background: linear-gradient(45deg, #2d8cf0, #5cadff)"
          />
          <div class="date-cont">
            <CountTo
              class="count"
              :start-val="0"
              :end-val="statistics.animalCount"
              :duration="3000"
            />
      ...
      <el-card shadow="hover" :body-style="{ padding: '0px' }" class="data-col">
        <div class="date-block">
          <i
            class="el-icon-s-custom icon-box"
            style="background: linear-gradient(45deg, #19be6b, #39d353)"
          />
          <div class="date-cont">
            <CountTo
              class="count"
              :start-val="0"
              :end-val="statistics.userCount"
              :duration="3000"
            />
      ...
      <el-card shadow="hover" :body-style="{ padding: '0px' }" class="data-col">
        <div class="date-block">
          <i
            class="el-icon-s-order icon-box"
            style="background: linear-gradient(45deg, #ff9900, #ffb84d)"
          />
          <div class="date-cont">
            <CountTo
              class="count"
              :start-val="0"
              :end-val="statistics.adoptCount"
              :duration="3000"
            />
      ...
      <el-card shadow="hover" :body-style="{ padding: '0px' }" class="data-col">
        <div class="date-block">
          <i
            class="el-icon-money icon-box"
            style="background: linear-gradient(45deg, #e46cbb, #f5a3d7)"
          />
          <div class="date-cont">
            <CountTo
              class="count"
              :start-val="0"
              :end-val="statistics.orderCount"
              :duration="3000"
            />
      ...
      <el-card shadow="hover" :body-style="{ padding: '0px' }" class="data-col">
        <div class="date-block">
          <i
            class="el-icon-house icon-box"
            style="background: linear-gradient(45deg, #9a66e4, #b794f4)"
          />
          <div class="date-cont">
            <CountTo
              class="count"
              :start-val="0"
              :end-val="statistics.fosterCount"
              :duration="3000"
            />
            <p class="title">寄养总数</p>
            <p class="sub-title">
              当前寄养: {{ statistics.currentFosterCount }}
            </p>
          </div>
        </div>
      </el-card>
    ...
    <div class="charts-container">
      <el-row :gutter="20">
        ...
        <!-- 中间图表（加大尺寸） -->
        <el-col :span="10">
          <el-card shadow="hover" class="chart-card middle-chart">
            <div slot="header" class="chart-header">
              <span>近1年领养趋势</span>
            </div>
...
@import "../../../assets/less/scroller-bar.less";
